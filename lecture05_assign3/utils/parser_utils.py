...
class Parser(object):
    ...
    def parse(self, dataset, sess, y_pred_softmax, x, eval_batch_size=5000):
        sentences = []
        sentence_id_to_idx = {}
        ...
        model = ModelWrapper(self, dataset, sentence_id_to_idx, sess, y_pred_softmax,x)
...
class ModelWrapper(object):
    def __init__(self, parser, dataset, sentence_id_to_idx, sess, y_pred_softmax,x):
        self.parser = parser
    ...
    def predict(self, partial_parses):
        ...
        pred = self.sess.run(self.y_pred_softmax, feed_dict={self.x: mb_x})
