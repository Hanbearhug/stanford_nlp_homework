...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        uncompleted_sample = [sample for sample in mini_batch if ((sample.buffer) or (len(sample.stack))!=1)]
        uncompleted_sample_dependence = [sample.dependencies for sample in uncompleted_sample]
        try:
            unfinished_parses = uncompleted_sample+unfinished_parses[batch_size:]
        except:
            unfinished_parses = uncompleted_sample
